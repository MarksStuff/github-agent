...
def fix_test_file(file_path):
    ...
    patterns_to_fix = [
        ...
        (r"codebase_tools\.TOOL_HANDLERS", r"tools_instance.TOOL_HANDLERS"),
    ]
    ...
    response_fixes = [
        ...
        (
            r'assert data\["status"\] == "unhealthy"',
...
"""
    ...
    content = re.sub(
        method_pattern, add_setup_if_missing, content, flags=re.MULTILINE | re.DOTALL
    )
