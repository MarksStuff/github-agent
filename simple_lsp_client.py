...
class SimpleLSPClient:
    ...
    async def get_definition(self, file_uri: str, line: int, character: int, timeout: float = 10.0) -> list[dict[str, Any]]:
    ...
    async def get_references(self, file_uri: str, line: int, character: int, timeout: float = 10.0) -> list[dict[str, Any]]:
    ...
    async def get_hover(self, file_uri: str, line: int, character: int, timeout: float = 10.0) -> dict[str, Any] | None:
    ...
    async def _send_message(self, proc: asyncio.subprocess.Process, message: dict[str, Any]) -> None:
