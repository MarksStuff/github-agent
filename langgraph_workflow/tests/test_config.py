...
class TestMCPConfig(unittest.TestCase):
    ...
    def test_default_mcp_config(self):
        ...
        self.assertIn("/api/github/pr/{pr_number}/checks/{check_id}/logs", endpoints["check_logs"])
    
    @patch.dict(os.environ, {"MCP_ENABLED": "true", "MCP_SERVER_URL": "http://custom:9090"})
...
class TestEscalationLogic(unittest.TestCase):
    ...
    def test_escalate_on_consecutive_failures(self):
        ...
        self.assertTrue(should_escalate_to_claude(consecutive_failures=2))  # At threshold
    ...
    def test_escalate_on_complexity_score(self):
        ...
        self.assertFalse(should_escalate_to_claude(complexity_score=0.7))  # At threshold
    ...
    def test_escalate_multiple_criteria(self):
        ...
        self.assertTrue(should_escalate_to_claude(
            diff_size=400,  # High
            files_touched=5,  # Low
        ...
        self.assertFalse(should_escalate_to_claude(
            diff_size=100,  # Low
            files_touched=5,  # Low
            consecutive_failures=1,  # Low
            complexity_score=0.3  # Low
...
class TestConfigurationValidation(unittest.TestCase):
    ...
    def test_resource_limits_consistency(self):
        ...
        self.assertGreaterEqual(limits["max_ollama_concurrent"], limits["max_claude_concurrent"])
