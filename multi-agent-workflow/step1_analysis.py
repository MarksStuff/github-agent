...
Examples:
  ...
  python step1_analysis.py task.md --log-level DEBUG    # Debug output
    ...
    codebase_analysis_path = orchestrator.get_absolute_path(".workflow/codebase_analysis.md")
    ...
    if result["status"] == "success":
        ...
        print("\nNext steps:")
        print(f"1. Review the analysis documents in {repo_path}/.workflow/round_1_analysis/")
        print("2. Provide feedback via GitHub PR comments")
        print("3. Run 'python step2_create_design_document.py --pr {}'".format(result['pr_number']))
